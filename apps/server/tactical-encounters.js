...
function defaultState() {
  return {
    ...
    phases: [], activePhaseId: null, zones: [], crowdRegions: [], tethers: [], spotlights: [], spotlightQueue: [], tokenFamilies: [], annotations: [], aoes: [], events: [], eventLog: [],
  };
}
...
function normalizeState(raw, version = 1) {
  ...
  state.phases = state.phases.map((phase) => ({ ...phase, recipe: phase.recipe || { showTokenIds: phase.activeTokenIds || [], activateZoneIds: phase.activeZoneIds || [], activateCrowdRegionIds: phase.activeCrowdRegionIds || [] } }));
