...
function Feed() {
  return <main className="secret-site-page pixie-site"><header className="pixie-feed-header"><div className="pixie-profile-mark"><strong>pixie</strong><LumiSticker sticker="moth" size={54} rotate={-5} /><LumiSticker sticker="sparkle" size={28} rotate={8} /></div><span>@xX_LumiLuvsYuri_Xx</span></header><div className="pixie-feed">
    ...
    <PixiePost sticker="big-heart" tags={["#lyra glimmerthirst", "#divine muse of summer", "#normal amount of admiration", "#i am looking respectfully", "#lying"]}><strong className="pixie-repost-label">reposted <LumiSticker sticker="arrow" size={27} rotate={-5} /></strong><p>important cultural preservation work happening on this blog</p><img src={PIXIE_POST_IMAGES.lyra} alt="Fan art of Lyra Glimmerthirst" /><p>look at her. LOOK AT HER.</p></PixiePost>
    ...
    <PixiePost sticker="purple-heart" stickerSide="left" tags={["#rin", "#mimi", "#yuri goggles permanently installed", "#research"]}><strong className="pixie-repost-label">reposted <LumiSticker sticker="sparkle" size={24} rotate={6} /></strong><img src={PIXIE_POST_IMAGES.rinAndMimi} alt="Fan art of Rin and Mimi together" loading="lazy" /><p>girls can literally just stand next to each other and suddenly i have seventeen tabs open</p></PixiePost>
    ...
    <PixiePost sticker="speech-question" stickerSide="left"><img src={PIXIE_POST_IMAGES.thalanorAndPip} alt="Fan art of Thalanor and Pip" loading="lazy" /></PixiePost>
    <PixiePost sticker="sweat-drops"><img src={PIXIE_POST_IMAGES.titaniaAndWinterQueen} alt="Human alternate-universe fan art of Titania and the Winter Queen" loading="lazy" /></PixiePost>
    <PixiePost sticker="speech-heart" tags={["#asks", "#faebook", "#skill issue"]}><div className="pixie-ask"><strong>anonymous asked:</strong><p>why do you have access to the production stylesheet</p></div><p>because nobody stopped me early enough</p></PixiePost>
    ...
    <footer className="pixie-sticker-footer" aria-label="End of feed"><LumiSticker sticker="ghost" size={46} rotate={-5} /><LumiSticker sticker="big-heart" size={31} rotate={8} /><LumiSticker sticker="sparkle" size={27} rotate={-7} /></footer>
  </div></main>;
}
